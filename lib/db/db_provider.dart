...
class DBProvider {
  ...
  var tasks = [
    Task('خرید', id: '1',  color: Colors.purple.value, codePoint: Icons.shopping_cart.codePoint),
    Task('تمرین', id: '2', color: Colors.pink.value, codePoint: Icons.fitness_center.codePoint),
  ];
